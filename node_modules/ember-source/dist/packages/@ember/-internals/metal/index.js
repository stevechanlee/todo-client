...
import { setListeners, enumerableSymbol, isObject, setupMandatorySetter, symbol, toString, setWithMandatorySetter, Cache, HAS_NATIVE_PROXY, setProxy, lookupDescriptor, inspect, getName, setName, guidFor, makeArray, observerListenerMetaFor, ROOT, setObservers, wrap } from '@ember/-internals/utils';
...
import { CURRENT_TAG, tagMetaFor, validateTag, valueForTag, CONSTANT_TAG, dirtyTagFor, tagFor, ALLOW_CYCLES, combine, createUpdatableTag, updateTag, consumeTag, deprecateMutationsInAutotrackingTransaction, isTracking, track, untrack, trackedData } from '@glimmer/validator';
...
function DESCRIPTOR_SETTER_FUNCTION(name, descriptor) {
  let func = function CPSETTER_FUNCTION(value) {
